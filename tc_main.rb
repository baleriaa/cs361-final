...
class TestMain < Test::Unit::TestCase
  ...
  def test_feature
    ...
    feature.add_property("icon", "dot")
    feature.add_geometry("geometry", Point.new(-121.5, 45.6))
    expected = '{"type": "Feature","properties": {"title": "store","icon": "dot"},"geometry": {"type": "Point","coordinates": [-121.5,45.6]}'.to_json
    result = feature.to_json
    assert_equal(expected, result)
  end
